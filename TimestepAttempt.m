...
ra_month = zeros(12,1);
filename = 'Optimal Solution.xlsx';
...
%         variable gamma_ra_sc(vecLength);
    ...
    if months(m) == "July" 
        ...
        saveas(gca,"July_stats.png")
    end
    full_powerOpt = zeros(vecLength,4);
